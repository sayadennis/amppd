# The purpose of this script is to parse through the filtered VCF files to generate a variant count matrix for modeling
...
mx_filename = "variant_count_table.csv"
