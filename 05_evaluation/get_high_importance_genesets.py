...
pf = pd.read_csv(f'{pfdir}/amppd_v2_classicalml_bcor_pca.csv', index_col=0)
...
m_fn = '/projects/b1131/saya/amppd_v2/models/20220324_saved_best_XGB_vc_mx_bcor_pca_reverse_tf.p' # model filename
...
X = pd.read_csv(f'{inputdir}/vc_mx_bcor_pca_reverse_tf.csv', index_col=0)
