...
din='/projects/b1131/saya/amppd_v2/wgs/03_annovar'
...
for i in range(1,23):
    flist=glob.glob(f'{din}/chr{i}_subset*_av.hg38_multianno.txt')
...
ax.set_title('ANNOVAR Progress')
ax.legend()
fig.savefig(f'{dout}/{timestamp}_annovar_progress.png')
